...
public class LinkedListTests {
    ...
    public static void main(String[] args) {
...

        {
            ...
            // verify
            System.out.println("Stack: " + stack.peek() + " == 1");
            System.out.println("Stack: " + stack.pop() + " == 1");
            System.out.println("Stack: " + stack.peek() + " == 2");
            
            System.out.println("Queue: " + queue.peek() + " == 1");
            System.out.println("Queue: " + queue.poll() + " == 1");
            System.out.println("Queue: " + queue.peek() + " == 2");
            ...
            System.out.println("Stack: " + stack.peek() + " == 5");
